...
socket.on('created', function (room) {
    console.log('Function created on socket');
    navigator.mediaDevices.getUserMedia(streamConstraints).then(function (stream) {
        addLocalStream(stream, 'created');
        isCaller = true;
    }).catch(function (err) {
...
socket.on('joined', function (room) {
    console.log('Function joined on socket');
    navigator.mediaDevices.getUserMedia(streamConstraints).then(function (stream) {
        addLocalStream(stream, 'joined');
...
socket.on('ready', function () {
    console.log('Function ready socket')
    if (isCaller) {
...
socket.on('offer', function (event) {
    console.log('Function offer socket')
    if (!isCaller) {
        createPeerConnection();
...
//utility functions
function addLocalStream(stream, NameFunction) {
